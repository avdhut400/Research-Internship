...
#             f"classes.txt file not found: {CLASSES_PATH}"
#         )
...
#         print("Model loading RuntimeError:")
#         print(str(error))

#         raise RuntimeError(
#             "Model load करताना RAM कमी पडली किंवा "
#             "model architecture mismatch आहे. "
#             "Server --reload शिवाय run करा आणि "
#             "Windows virtual memory वाढवा."
#         ) from error
...
# # ---------------------------------------------------------
# # Determine Pure / Adulterated Status
# # ---------------------------------------------------------
...
#     # Pure classes
#     if class_name_lower.startswith("pure_"):
...
#         oil_name = predicted_class.split(
#             "_"
#         )[0]
...
#         for keyword in adulterated_keywords
#     ):
#         return {
#             "status": "Adulterated",
#             "oilType": None,
...
#     )
#     print(f"Selected model: {latest_model.name}")
#     return latest_model
...
#         raise FileNotFoundError(f"classes.txt file not found: {CLASSES_PATH}")

#     content = CLASSES_PATH.read_text(encoding="utf-8").strip()
#     if not content:
#         raise ValueError("classes.txt file is empty")

#     content = content.replace("\n", ",")
#     classes = [name.strip() for name in content.split(",") if name.strip()]
...
#     except RuntimeError as error:
#         raise RuntimeError(
#             "The model could not be loaded. Possible causes are insufficient "
#             "memory or a mismatch between the model architecture and weights. "
#             "Run Uvicorn without --reload and increase Windows virtual memory if needed."
#         ) from error
...
#         oil_name = predicted_class.replace("Pure_", "", 1)
#         return {
#             "status": "Pure",
#             "oilType": oil_name,
#             "details": f"Pure {oil_name} Oil",
...
#     numbers = re.findall(r"\d+", predicted_class)
#     if numbers:
#         percentage = int(numbers[0])
...
#             "status": "Adulterated",
#             "oilType": oil_name,
#             "details": f"{oil_name} oil contains {percentage}% Palm Oil",
#             "adulterationPercentage": percentage,
#         }

#     if any(word in lower_name for word in ["palm", "adulterated", "impure"]):
#         return {
#             "status": "Adulterated",
#             "oilType": None,
#             "details": "Adulterated Oil",
...
#         "status": "Unknown",
#         "oilType": None,
#         "details": "Unable to determine purity status",
#         "adulterationPercentage": None,
#     }
...
#     input_tensor = image_transform(image.convert("RGB")).unsqueeze(0).to(device)
...
#     status_result = get_oil_status(predicted_class)
...
#     top_predictions = [
#         {
#             "className": class_names[index.item()],
...
#         "oilType": status_result["oilType"],
#         "details": status_result["details"],
#         "adulterationPercentage": status_result["adulterationPercentage"],
